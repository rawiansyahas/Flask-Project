...
app = Flask(__name__)
model = load_model('cassava_inception_model.h5')
target_img = os.path.join(os.getcwd(), 'static/images')

labels = labels = ['Cassava Bacterial Blight', 'Cassava Brown Streak Disease', 'Cassava Green Mottle', 'Cassava Mosaic Disease', 'Healthy']
